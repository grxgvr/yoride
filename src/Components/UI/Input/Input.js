...
const input = (props) => {
    ...
    switch (props.type) {
        case "input":
          inputEl = <input className={classes} value={props.value} onChange={props.changed} placeholder={props.placeholder}/>;
          break;
        case "password":
        ...
        case "date":
          ...
          break;
        case "textarea":
          inputEl = <textarea className='InputEl' className = {classes} placeholder={props.placeholder} onChange={props.changed}/>;
          break;
        case "time":
